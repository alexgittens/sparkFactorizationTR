...
\end{equation*}
Low-rank matrix factorization methods are important tools in linear algebra and numerical analysis, and they find use in a variety of scientific fields and scientific computing. Throughout, we assume the data matrix $A$ has size $m \times n$ and rank $r$, with $r \ll n \ll m$; this ``tall-skinny'', highly rectangular setting is common in practice. 
